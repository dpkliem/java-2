...
public class GraphListen {
	...
	/**
	 * Gibt den Grad (Anzahl der angrenzenden Kanten) f�r den angegebenen Knoten v
	 * zurueck.
	 */
	 ...
	 * anschlie�end geoeffnet und ein Graph-Objekt erzeugt bzw. der Graph wird
	 * ausgegeben.
	 */
