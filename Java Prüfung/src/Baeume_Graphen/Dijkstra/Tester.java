package Baeume_Graphen.Dijkstra;
...
public class Tester {
	...
	public static void main(String[] args) {
		...
		Node duesseldorf = new Node("D�sseldorf", 51.233, 6.783, false);
		...
		Node muenchen = new Node("M�nchen", 48.133, 11.567, false);
		Node potsdam = new Node("Potsdam", 52.401, 13.049, false);
		Node saarbruecken = new Node("Saarbr�cken", 49.233, 7.000, false);
