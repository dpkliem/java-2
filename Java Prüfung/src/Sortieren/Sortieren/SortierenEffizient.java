...
public class SortierenEffizient {
  ...
  // ---------------------------------------------
  // Hilfsmethoden f�r Object-Arrays
  // ---------------------------------------------
  ...
  // Sortieren durch Zaehlen des Vorkommens f�r nichtnegative ganze Zahlen
  ...
  // wenn keine obere Schranke f�r die Werte des Arrays bekannt ist,
...
//    printArray(c0);
    ...
    System.out.println("Zeit f�r " + anzahl1 + " Objekte: " + (t2 - t1));
    if (!istGeordnet(c)) System.out.println("\nhier stimmte was nicht!\n");
    System.out.println("Ende Merge-Sort\n");

    System.out.println("Merge-Sort f�r Rational");
    ...
    mergeSort(c);
    t2 = System.currentTimeMillis();
    System.out.println("Zeit f�r " + anzahl1 + " Rationals: " + (t2 - t1));
    if (!istGeordnet(c)) {
      System.out.println("\nhier stimmte was nicht!\n");

    }
    System.out.println("Ende Merge-Sort f�r Rational\n");
...
//*
    ...
    System.out.println("Ende Shell-Sort 4 \n");
     ...
     // nur f�r nichtnegative ganze Zahlen
     ...
     countSort(b);
     t2 = System.currentTimeMillis();
     System.out.println("Zeit f�r " + anzahl1 + " Zahlen: " + (t2 - t1));
