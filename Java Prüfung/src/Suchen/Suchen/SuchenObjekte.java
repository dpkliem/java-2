...
public class SuchenObjekte {
	...
	/**
	 * Grundalgorithmus: sequentielle Suche f�r ein beliebiges Objekt-Array
	 *  
    ...
    // vollst�ndiger Array von geordneten Integer-Objekten zum Testen
    /**
     * 
    ...
    public static void main(String[] args) {
        ...
        objekte = randIntegerArray(anzahl);
        gesucht = anzahl - 1;//new Integer(anzahl - 1);
        System.out.println("sequentielle Suche mit Z�hl-Schleife");
