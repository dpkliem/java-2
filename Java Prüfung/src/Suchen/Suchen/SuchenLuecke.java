...
public class SuchenLuecke {
	...
	public static int lueckeImUngeordnetenArray(int[] zahlen) throws NoSuchElementException {
		...
		if (i < istVorhanden.length) {
			...
			throw new NoSuchElementException("keine L�cke im Array");
		}
	...
	public static void main(String[] args) {
		...
		System.out.println("L�cke im ungeordneten Array suchen: ");
		luecke = lueckeImUngeordnetenArray(zahlen);
		System.out.println(luecke + " ist L�cke in ");
		System.out.println(Arrays.toString(zahlen));
		System.out.println();

		zahlen = lueckeIntegerArray(20);
		System.out.println("L�cke im geordneten Array suchen: ");
		...
		System.out.println("L�cke im geordneten Array suchen: " + Arrays.toString(zahlen));
		luecke = lueckeImGeordnetenArray(zahlen);
		System.out.println(luecke + " ist L�cke in ");
		System.out.println(Arrays.toString(zahlen));
		System.out.println();
